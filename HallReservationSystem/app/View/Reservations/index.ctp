<div class="reservations index">
	...
	<tr>
			<th><?php echo $this->Paginator->sort('rID'); ?></th>
	...
	<tr>
		<td><?php echo h($reservation['Reservation']['rID']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $reservation['Reservation']['rID']), null, __('Are you sure you want to delete # %s?', $reservation['Reservation']['rID'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
